  ...
  return (
    ...
    { isSheltered === "false" ? (
      <>
        ...
        <SlidersHorizontal onClick={() => navigation("/settings")} className="stroke-white hover:cursor-pointer hover:scale-105 transition" size={20}/>
      </div>
    ...
    (
      <>
        <div className="flex flex-row w-full justify-end pt-3 px-4">
        <SlidersHorizontal onClick={() => navigation("/settings")} className="stroke-white" size={20}/>
      </div>
